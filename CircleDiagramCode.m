% This program allows you o plot a power circle diagram using given Values
...
% the circle diagram location in the *a + ib* format.
%The Values of the A and B parameter is to be given in the *a + ib* format.

%------------------------Input Section-------------------------------------
Vs = input('Enter Vs in (a + bi) form : ');                     %Taking Inputs for the Sending end voltage vector
Vr = input('Enter Vr in (a + bi) form : ');                        %taking input for the Receiving end voltage Vector
A = input('Enter the A Parameter in (a + bi) form : ');     %Takng input for the A parameter of the transmission line
B = input('Enter the B Parameter in (a + bi) form : ');     %Taking input for the B parameter of the Transmission line
...
hold on 
x1 = R*cos(th) - CntrR*cos(angle(B));  %Equation of the circle 
y1 = R*sin(th) - CntrR*sin(angle(B));    %in cartesian form
